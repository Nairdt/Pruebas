...
public class ServicioController {
    public void nuevoServicio(Context context){
        ...
        repositorioDeServicios.entityManager().close();
    ...
    public void servicio(Context context) {
        try {
            ...
            ServicioPorEstablecimiento servicio = new RepositorioDeServicios().buscarServicioPorEstablicimientoPorId(idServicio);
    ...
    public void editarServicio(Context context){
        int idServicio = Integer.parseInt(Objects.requireNonNull(context.pathParam("id_servicio")));
        int tipoServ = Integer.parseInt(Objects.requireNonNull(context.formParam("tipoServicio")));
        ...
        ServicioPorEstablecimiento servicioAEditar = new RepositorioDeServicios().buscarServicioPorEstablicimientoPorId(idServicio);
        TipoServicio tipoServicio = new RepositorioDeServicios().buscarTipoServicioPorId(tipoServ);
    ...
    public void cambiarEstadoServicio(Context context){
        try {
            ...
            RepositorioDeServicios repositorioDeServicios = new RepositorioDeServicios();
                repositorioDeServicios.entityManager().getTransaction().begin();
            ServicioPorEstablecimiento servicioACambiarEstado = new RepositorioDeServicios().buscarServicioPorEstablicimientoPorId(idServicio);
    ...
    public boolean nuevoServicio(List<Servicio> servicios, String nombreServicio){
        return servicios.stream().anyMatch(unServicio ->
                unServicio.getNombre().equalsIgnoreCase(nombreServicio)
        );
    }

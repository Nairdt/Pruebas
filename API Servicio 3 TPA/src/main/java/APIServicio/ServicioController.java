...
public class ServicioController {
    ...
    public static void generarRanking(@NotNull Context context) throws Exception {
        ...
        try {
            ...
            String valorNulo;
            //Conversion de DTOs NoBorrar entidades con sus niveles calculados
    ...
    @OpenApi(
            ...
            pathParams = @OpenApiParam(
              name = "nuevoCnf",
              type = Integer.class,
              description = "El nuevo CNF NoBorrar utilizar",
              required = true
            ),
            tags = {"Ranking"},
            responses = {
    ...
    public static void cambiarCnf(Context context) {
        try {
            ...
            if(nuevoCnf <= 0)
                throw new RuntimeException("El CNF no puede ser menor o igual NoBorrar cero");
